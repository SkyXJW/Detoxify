...
if __name__ == "__main__":
    ...
    # 加载训练数据
    validation_data_pos = torch.load("/home/xjg/myTruthX/data/dinm/SafeEdit/llava/val_common_representations_pos.pth")
    validation_data_neg = torch.load("/home/xjg/myTruthX/data/dinm/SafeEdit/llava/val_common_representations_neg.pth")
