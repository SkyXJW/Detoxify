...
# 加载训练好的模型权重
checkpoint = torch.load("/home/xjg/TruthX/mistral_truthx_model_100epoch_300sample.pt")
model.load_state_dict(checkpoint['state_dict'])
model.eval()
model.to(device)

# 加载训练数据
train_data_pos = torch.load("/home/xjg/myTruthX/data/dinm/SafeEdit/mistral/300_train_common_representations_pos.pth")
train_data_neg = torch.load("/home/xjg/myTruthX/data/dinm/SafeEdit/mistral/300_train_common_representations_neg.pth")
